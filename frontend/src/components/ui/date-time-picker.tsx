...
interface DateTimePickerProps
  extends Omit<React.ComponentProps<"button">, "type" | "value" | "onChange"> {
  value?: string
...
export function DateTimePicker({
  ...
  const displayValue = selectedDate ? format(selectedDate, "yyyy/MM/dd HH:mm") : placeholder
      ...
      <div className="flex gap-2">
        <Popover open={open} onOpenChange={setOpen}>
          ...
          <PopoverContent align="start" className="w-auto p-0">
            <div className="grid grid-cols-1 overflow-hidden sm:grid-cols-[18rem_4.5rem_4.5rem]">
              <div className="p-3">
