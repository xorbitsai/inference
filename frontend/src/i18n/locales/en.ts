const en = {
  ...
  launchModel: {
    ...
    embed_vision: 'Vision',
    embed_video: 'Video Recognition',
    embed_audio: 'Audio Recognition',
    rerank_vision: 'Image Recognition',
    rerank_video: 'Video Recognition',
    rerank_audio: 'Audio Recognition',
  ...
  runningModels: {
    ...
    detail: {
      ...
      replica: 'Replicas',
      address: 'Address',
      noInteractiveCapability: 'No supported interactive capability',
      noInteractiveCapabilityDescription:
        'This model is running, but the current UI does not have a panel for its abilities yet.',
      backToRunningModels: 'Back to running models',
      generate: 'Generate',
      reset: 'Reset',
      results: 'Results',
      latency: 'Latency',
      ...
      textInput: 'Text',
      embeddingTextPlaceholder: 'Enter text to vectorize...',
      uploadImage: 'Upload image',
      embeddingImageDescription: 'Upload the image to vectorize',
      videoInput: 'Video',
      videoInputPlaceholder: 'Video URL or backend file path',
      audioInput: 'Audio',
      audioInputPlaceholder: 'Audio URL or backend file path',
      resultsPlaceholder: 'Results will appear here.',
      generating: 'Generating',
      progress: 'Progress',
      receivingAudioStream: 'Receiving audio stream',
      audioPlaybackAfterComplete: 'This browser will start playback when the stream is complete.',
      audioStreamingPlayback: 'Streaming and playing audio as it arrives.',
      audioGenerationComplete: 'Audio generation complete.',
      audioStreamUnavailable: 'The browser did not return a readable audio stream.',
      downloadAudio: 'Download audio',
      speakerEmbeddingGenerated: 'Speaker embedding generated',
      dimensions: 'dimensions',
      embeddingVector: 'Embedding vector',
      valueCount: '{{count}} values',
      speakerEmbeddingPlaceholder: 'Upload a speech sample to extract its speaker embedding.',
      thinkingCompleted: 'Thinking completed',
      thinking: 'Thinking...',
      chatEmpty: 'Start by sending a message or attaching media.',
      chatPlaceholder: 'Enter a message',
      additionalInputs: 'Additional inputs',
      maxTokensLabel: 'Max tokens (0 uses the maximum available)',
      temperature: 'Temperature',
      stream: 'Stream',
      save: 'Save',
      apiExamplesDescription: 'API request examples for the selected model ability.',
      getApiKey: 'Get API key',
      noApiExample: 'No API example is available for this model ability.',
      prompt: 'Prompt',
      promptPlaceholder: 'Describe what you want...',
      negativePrompt: 'Negative prompt',
      negativePromptPlaceholder: 'Things to avoid...',
      seed: 'Seed',
      randomSeedPlaceholder: '-1 = random',
      seedValidation: 'Seed must be -1 or an integer from 0 to {{max}}.',
      generateRandomSeed: 'Generate random seed',
      width: 'Width',
      height: 'Height',
      ...
      paddingMultiple: 'Padding multiple',
      strength: 'Strength',
      seeds: 'Seeds',
      imageSeedsPlaceholder:
        'Comma-separated; missing or -1 = random. For 4 images: 11, 22 = 11, 22, -1, -1',
      imageSeedsValidation:
        'Use up to {{count}} comma-separated seeds; each must be -1 or 0-{{max}}.',
      generateRandomImageSeeds: 'Generate a new random seed for every image',
      ...
      candidateParagraphPlaceholder: 'Candidate paragraph {{index}}',
      rerankVideoPlaceholder: 'Video URL or backend file path',
      rerankImagePlaceholder: 'Image URL or backend file path',
      rerankAudioPlaceholder: 'Audio URL or backend file path',
      removeCandidate: 'Remove candidate {{index}}',
      add: 'Add',
      documentPlaceholder: 'Document {{index}}',
      uploadImageOrPdf: 'Upload image or PDF',
      ocrUploadDescription: 'PNG, JPG, WebP, scanned page or PDF document',
      outputFormat: 'Output format',
      ocrOutputFormatTooltip:
      ...
      modelSizeTooltip: 'Choose the model size configuration',
      testCompress: 'Test compression',
      testCompressTooltip: 'Analyze image compression performance',
      saveResults: 'Save results',
      saveResultsTooltip: 'Save OCR results to files when supported',
      uploadReferenceImage: 'Upload reference image',
      uploadReferenceImageDescription: 'Upload an image to use as the reference',
      uploadFirstFrame: 'Upload first-frame image',
      firstFrame: 'First frame',
      lastFrame: 'Last frame',
      jsonObjectValidation: 'Enter a valid JSON object.',
      worldPromptPlaceholder: 'Describe the scene or action to generate...',
      cameraMotionLabel: 'Camera motion',
      cameraMotionDescription: 'Controls the camera trajectory used by Astra.',
      cameraMotion: {
        moveForward: 'Move forward',
        rotateLeft: 'Rotate left in place',
        rotateRight: 'Rotate right in place',
        forwardLeft: 'Move forward and turn left',
        forwardRight: 'Move forward and turn right',
        sCurve: 'Follow an S-curve',
        leftThenRight: 'Rotate left, then right',
      },
      generationConfig: 'Generation config (JSON)',
      generationConfigDescription: 'Common generation settings shared by the world API.',
      advancedModelKwargs: 'Advanced model parameters (JSON)',
      advancedModelKwargsDescription: 'Optional low-level model controls sent in extra_body.',
      uploadWorldImage: 'Upload initial world image',
      uploadWorldImageDescription: 'This image becomes the first frame of the generated world.',
      uploadWorldVideo: 'Upload initial world video',
      uploadWorldVideoDescription: 'Use a short source video supported by the selected model.',
      language: 'Language',
      languagePlaceholder: 'e.g. en, zh',
      audioPromptPlaceholder: 'Optional context or vocabulary',
      uploadSpeechSample: 'Upload a speech sample',
      speechSampleDescription:
        'Use clear speech; audio is converted to mono and resampled to 16 kHz.',
      total: 'Total',
      emotion: {
        happy: 'Happy',
        angry: 'Angry',
      ...
      musicDescriptionPlaceholder: 'Describe the music to generate',
      voiceInstructionPlaceholder: 'Describe the voice to generate',
      lyrics: 'Lyrics',
      speechTextPlaceholder: 'Enter text to synthesize...',
      voice: 'Voice',
      optionalVoiceId: 'Optional voice ID',
      speed: 'Speed',
      streaming: 'Streaming',
      streamingTooltip: 'Play supported audio formats while they are generated.',
      optional: 'Optional',
      optionalOtherFields: 'Optional (other fields)',
      optionalModelControls: 'Optional model-specific controls',
      durationSeconds: 'Duration (seconds)',
      promptSpeech: 'Prompt speech',
      promptSpeechDescription: 'Reference audio for cloning',
      promptText: 'Prompt text',
      promptTextPlaceholder: 'Text spoken in the prompt audio',
      emotionControl: 'Emotion control',
      emotionValidation: 'Use non-negative emotion values with a total no greater than 0.8.',
      microphoneDenied: 'Microphone access was denied. Allow access and try again.',
      microphoneNotFound: 'No microphone was found.',
      microphoneUnavailable: 'The microphone is unavailable or already in use.',
      microphoneStartFailed: 'Unable to start microphone recording.',
      noAudioCaptured: 'No audio was captured. Please try again.',
      microphoneUnsupported: 'Microphone recording is not supported in this browser or context.',
      recordingFailed: 'Recording failed. Please try again.',
      uploadOrDropAudio: 'Upload or drop audio',
      ...
      editImageAndMask: 'Edit image and create mask',
      orUploadMask: 'Or upload a mask image',
      maskImage: 'Mask image',
      optionalMaskImage: 'Optional mask image',
      currentMaskPreview: 'Current mask preview',
      error: 'Error',
      ocrFailed: 'OCR failed',
      noTextExtracted: 'No text extracted',
      ocrNoTextHelp:
        '**OCR complete, but no text was detected**\n\n**Possible reasons:**\n- The text is unclear or the resolution is too low\n- The image format is unsupported\n- The model could not recognize the text\n\n**Suggestions:**\n- Upload a clearer image\n- Make sure the text is clear and legible\n- Handwritten text may produce poorer results',
      compressionInfo: 'Compression ratio information',
      compressionRatio: 'Compression ratio',
      validImageTokens: 'Valid image tokens',
      outputTextTokens: 'Output text tokens',
      astraCameraMotionDuplicate: 'Set Astra cam_type in only one advanced JSON field.',
      astraCameraMotionConflict:
        'Astra cam_type conflicts with the selected camera motion. Use the selector as the source of truth.',
      extractEmbedding: 'Extract embedding',
    },
  ...
  logCenter: {
    ...
    detail: {
      ...
      viewCorrelated: 'View correlated logs',
      viewRequestBody: 'View request body',
      correlatedTitle: 'Correlated request timeline',
      correlatedFetchError: 'Failed to load correlated logs.',
      correlatedTruncated:
        'The result is truncated. Narrow the time range for the complete timeline.',
  ...
  userManagement: {
    ...
    permissionLabels: {
      ...
      'logs:list': 'View logs',
      'model_requests:read_body': 'View model request bodies',
