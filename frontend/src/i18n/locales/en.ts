const en = {
  ...
  launchModel: {
    ...
    'requestLimits.optional':
      '(Optional) Request Limits, the number of request limits for this model, default is None',
    'workerIp.optional':
      '(Optional) Worker Ip, specify the worker ip where the model is located in a distributed scenario,multiple IPs can be specified by separating them with commas.',
    workerIp:
      'Worker Ip, specify the worker ip where the model is located in a distributed scenario',
    ...
    'modelPath.optional':
      '(Optional) Model Path, For PyTorch, provide the model directory. For GGML/GGUF, provide the model file path.',
    'GGUFQuantization.optional':
      '(Optional) GGUF quantization format, quantizing the Transformer part.',
