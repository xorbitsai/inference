const en = {
  ...
  apiKey: {
    ...
    noLimit: 'No limit',
    usedTokensUnlimited: '{{used}} used',
    usedTokens: '{{used}} / {{total}} used · {{remaining}} remaining',
    tokenRenewal_none: 'No renewal',
    tokenRenewal_daily: 'Daily',
    tokenRenewal_monthly: 'Monthly',
    tokenRenewal_custom: 'Custom',
    rateLimitUsage: '{{used}} / {{total}} used · {{remaining}} remaining',
    advancedSettings: 'Advanced Settings',
    advancedSettingsHint: 'Control token budget, renewal, expiration, and request rate limit.',
    tokenBudget: 'Token Budget',
    tokenBudgetHint: 'Leave empty for unlimited tokens.',
    tokenRenewalIntervalDays: 'Renewal Interval Days',
    tokenRenewalIntervalRequired: 'Renewal interval is required',
    requestRateLimitEnabled: 'Enable request rate limit',
    rateLimitRequests: 'Requests',
    rateLimitRequestsRequired: 'Request count is required',
    rateLimitWindowSeconds: 'Window Seconds',
    rateLimitWindowRequired: 'Window seconds is required',
    rotateKey: 'Rotate API Key',
    keyRotated: 'API Key Rotated',
    rotate: 'Rotate',
    rotating: 'Rotating...',
    rotateKeyConfirm: 'Rotating this API key immediately invalidates the old secret. Continue?',
    rotateKeyWarning: 'Copy and store the new API key now. It will not be shown again.',
