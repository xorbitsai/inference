const ja = {
  ...
  userManagement: {
    ...
    deleteTitle: 'ユーザーを削除',
    deleteDescription: 'このユーザーを削除してもよろしいですか？この操作は元に戻せません。',
  },
  apiKey: {
    ...
    noLimit: '制限なし',
    usedTokensUnlimited: '{{used}} 使用済み',
    usedTokens: '{{used}} / {{total}} 使用済み · 残り {{remaining}}',
    tokenRenewal_none: '更新なし',
    tokenRenewal_daily: '毎日',
    tokenRenewal_monthly: '毎月',
    tokenRenewal_custom: 'カスタム',
    rateLimitUsage: '{{used}} / {{total}} 使用済み · 残り {{remaining}}',
    advancedSettings: '詳細設定',
    advancedSettingsHint: 'トークン予算、更新、有効期限、リクエスト制限を制御します。',
    tokenBudget: 'トークン予算',
    tokenBudgetHint: '空欄の場合はトークン無制限。',
    tokenRenewalIntervalDays: '更新間隔（日）',
    tokenRenewalIntervalRequired: '更新間隔は必須です',
    requestRateLimitEnabled: 'リクエスト制限を有効化',
    rateLimitRequests: 'リクエスト数',
    rateLimitRequestsRequired: 'リクエスト数は必須です',
    rateLimitWindowSeconds: 'ウィンドウ秒数',
    rateLimitWindowRequired: 'ウィンドウ秒数は必須です',
    rotateKey: 'API キーをローテーション',
    keyRotated: 'API キーがローテーションされました',
    rotate: 'ローテーション',
    rotating: 'ローテーション中...',
    rotateKeyConfirm: 'ローテーションすると古いシークレットは直ちに無効になります。続行しますか？',
    rotateKeyWarning: '新しい API キーを今すぐコピーして保存してください。再表示されません。',
