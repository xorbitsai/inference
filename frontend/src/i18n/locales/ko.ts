const ko = {
  ...
  userManagement: {
    ...
    deleteTitle: '사용자 삭제',
    deleteDescription: '이 사용자를 삭제하시겠습니까? 이 작업은 되돌릴 수 없습니다.',
  },
  apiKey: {
    ...
    lastRotated: '마지막 교체',
    noLimit: '제한 없음',
    usedTokensUnlimited: '{{used}} 사용됨',
    usedTokens: '{{used}} / {{total}} 사용됨 · {{remaining}} 남음',
    tokenRenewal_none: '갱신 없음',
    tokenRenewal_daily: '매일',
    tokenRenewal_monthly: '매월',
    tokenRenewal_custom: '사용자 지정',
    rateLimitUsage: '{{used}} / {{total}} 사용됨 · {{remaining}} 남음',
    advancedSettings: '고급 설정',
    advancedSettingsHint: '토큰 예산, 갱신, 만료, 요청 속도 제한을 제어합니다.',
    tokenBudget: '토큰 예산',
    tokenBudgetHint: '비워두면 토큰 제한이 없습니다.',
    tokenRenewalIntervalDays: '갱신 간격(일)',
    tokenRenewalIntervalRequired: '갱신 간격은 필수입니다',
    requestRateLimitEnabled: '요청 속도 제한 사용',
    rateLimitRequests: '요청 수',
    rateLimitRequestsRequired: '요청 수는 필수입니다',
    rateLimitWindowSeconds: '윈도우 초',
    rateLimitWindowRequired: '윈도우 초는 필수입니다',
    rotateKey: 'API 키 교체',
    keyRotated: 'API 키가 교체되었습니다',
    rotate: '교체',
    rotating: '교체 중...',
    rotateKeyConfirm: '교체하면 이전 시크릿은 즉시 무효화됩니다. 계속하시겠습니까?',
    rotateKeyWarning: '새 API 키를 지금 복사하여 저장하세요. 다시 표시되지 않습니다.',
