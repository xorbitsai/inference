const zh = {
  ...
  userManagement: {
    ...
    deleteTitle: '删除用户',
    deleteDescription: '确定要删除此用户吗？此操作不可撤销。',
  },
  apiKey: {
    ...
    tokenRenewal: 'Token 续期',
    rateLimit: '请求限流',
    lastRotated: '最近轮换',
    noLimit: '无限制',
    usedTokensUnlimited: '已使用 {{used}}',
    usedTokens: '已使用 {{used}} / {{total}} · 剩余 {{remaining}}',
    tokenRenewal_none: '不续期',
    tokenRenewal_daily: '每天',
    tokenRenewal_monthly: '每月',
    tokenRenewal_custom: '自定义',
    rateLimitUsage: '已使用 {{used}} / {{total}} · 剩余 {{remaining}}',
    advancedSettings: '高级设置',
    advancedSettingsHint: '控制 Token 预算、续期、过期时间和请求限流。',
    tokenBudget: 'Token 预算',
    tokenBudgetHint: '留空表示 Token 不限量。',
    tokenRenewalIntervalDays: '续期间隔天数',
    tokenRenewalIntervalRequired: '请填写续期间隔',
    requestRateLimitEnabled: '启用请求限流',
    rateLimitRequests: '请求数',
    rateLimitRequestsRequired: '请填写请求数',
    rateLimitWindowSeconds: '窗口秒数',
    rateLimitWindowRequired: '请填写窗口秒数',
    rotateKey: '轮换 API Key',
    keyRotated: 'API Key 已轮换',
    rotate: '轮换',
    rotating: '轮换中...',
    rotateKeyConfirm: '轮换后旧密钥会立即失效。确定继续吗？',
    rotateKeyWarning: '请立即复制并保存新的 API Key，它不会再次显示。',
