...
- 組み込み [PaddleOCR-VL-1.6](https://huggingface.co/PaddlePaddle/PaddleOCR-VL-1.6): [#5033](https://github.com/xorbitsai/inference/pull/5033)
- 組み込み [VoxCPM2](https://huggingface.co/openbmb/VoxCPM2): [#5045](https://github.com/xorbitsai/inference/pull/5045)
- 組み込み [DeepSeek V4](https://api-docs.deepseek.com/news/news260424): [#4938](https://github.com/xorbitsai/inference/pull/4938)
- 組み込み [MiniMax-M2.7](https://www.minimax.io/models/text/m27): [#4843](https://github.com/xorbitsai/inference/pull/4843)
### 統合
...
- **企業/組織向け Xinference**
  企業向けの追加機能を提供しています。企業ニーズについてはメール（mailto:business@xprobe.io?subject=[GitHub]Business%20License%20Inquiry）でお問い合わせください。
...
最も手軽に Xinference を試す方法は、[Google Colab 上の Jupyter Notebook](https://colab.research.google.com/github/xorbitsai/inference/blob/main/examples/Xinference_Quick_Start.ipynb) を試すことです。
