...
- **Xinference for Enterprise**
  若需企業功能與支援，請聯絡： mailto:business@xprobe.io?subject=[GitHub]Business%20License%20Inquiry
...
* [範例與教學](https://inference.readthedocs.io/en/latest/examples/index.html)

### Jupyter Notebook

體驗 Xinference 的最簡單方式是使用 [Google Colab 的 Jupyter Notebook](https://colab.research.google.com/github/xorbitsai/inference/blob/main/examples/Xinference_Quick_Start.ipynb)。
