...
- 內建支援 [MiniMax-H3](https://huggingface.co/MiniMaxAI/MiniMax-H3) 和 [Lightning LoRA](https://huggingface.co/lightx2v/Minimax-h3-Turbo)： [#5321](https://github.com/xorbitsai/inference/pull/5321)、[#5338](https://github.com/xorbitsai/inference/pull/5338)
...
- 內建支援 [DeepDoc](https://huggingface.co/Xorbits/deepdoc)： [#5230](https://github.com/xorbitsai/inference/pull/5230)
- 內建支援 [jina-reranker-v3.5](https://huggingface.co/jinaai/jina-reranker-v3.5)： [#5269](https://github.com/xorbitsai/inference/pull/5269)
- 內建支援 R3 系列（[嵌入](https://huggingface.co/tencent/R3-embedding-0.6b)、[重排](https://huggingface.co/tencent/R3-rerank-0.6b)）： [#5272](https://github.com/xorbitsai/inference/pull/5272)
### 整合項目
