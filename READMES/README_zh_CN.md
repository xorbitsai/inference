...
<p align="center">
  ...
  <a href="./README_zh_CN.md"><img alt="简体中文" src="https://img.shields.io/badge/简体中文-454545?style=for-the-badge"></a>
</p>
</div>
<br />
...
- 内置支持 [Kimi-K3](https://huggingface.co/moonshotai/Kimi-K3): [#5417](https://github.com/xorbitsai/inference/pull/5417)
- 内置支持世界模型（[Matrix-Game-3.0-5B](https://huggingface.co/Skywork/Matrix-Game-3.0)、[HY-WorldPlay-5B](https://huggingface.co/tencent/HY-WorldPlay)、[Astra](https://huggingface.co/EvanEternal/Astra)）: [#5414](https://github.com/xorbitsai/inference/pull/5414)
- 内置支持 Krea 2 系列（[Raw](https://huggingface.co/krea/Krea-2-Raw)、[Turbo](https://huggingface.co/krea/Krea-2-Turbo)）: [#5419](https://github.com/xorbitsai/inference/pull/5419)
- 内置支持 [ACE-Step 1.5](https://huggingface.co/ACE-Step/Ace-Step1.5): [#5413](https://github.com/xorbitsai/inference/pull/5413)
- 内置支持 Ornith 1.5 系列（[35B-A3B](https://modelscope.cn/models/ornith-ai/Ornith-1.5-35B-A3B)、[397B](https://modelscope.cn/models/ornith-ai/Ornith-1.5-397B)）: [#5406](https://github.com/xorbitsai/inference/pull/5406), [#5405](https://github.com/xorbitsai/inference/pull/5405)
- 内置支持 [GLM-5.2](https://huggingface.co/zai-org/GLM-5.2): [#5404](https://github.com/xorbitsai/inference/pull/5404)
- 内置支持 [GLM-Image](https://huggingface.co/zai-org/GLM-Image): [#5394](https://github.com/xorbitsai/inference/pull/5394)
- 内置支持 HiDream-O1 系列（[Image](https://huggingface.co/HiDream-ai/HiDream-O1-Image)、[Image-Dev](https://huggingface.co/HiDream-ai/HiDream-O1-Image-Dev)、[Image-Dev-2604](https://huggingface.co/HiDream-ai/HiDream-O1-Image-Dev-2604)）: [#5370](https://github.com/xorbitsai/inference/pull/5370)
- 内置支持 [SenseNova-U1.5-8B-MoT](https://huggingface.co/sensenova/SenseNova-U1.5-8B-MoT): [#5369](https://github.com/xorbitsai/inference/pull/5369)
