...
class EmbeddingModel:
    ...
    def load(self):
        ...
        self.with_flag_embedding = False
    ...
    def create_embedding(self, sentences: Union[str, List[str]], **kwargs):
        ...
        for index, data in enumerate(all_embeddings):
            if kwargs.get("return_sparse") and self.with_flag_embedding:
        ...
        result = Embedding(
            object=(
                "list"  # type: ignore
                if not self.with_flag_embedding
                or not kwargs.get("return_sparse")
                else "dict"
            ),
