...
_TRACED_ROUTES: Dict[str, Tuple[str, str]] = {
    "/v1/chat/completions": ("llm", "chat_completions"),
    "/v1/completions": ("llm", "completions"),
    "/anthropic/v1/messages": ("llm", "anthropic_messages"),
    "/v1/flexible/infers": ("llm", "flexible_infers"),
    "/v1/embeddings": ("embedding", "embeddings"),
    ...
    "/v1/images/generations": ("image", "images_generations"),
    "/v1/images/variations": ("image", "images_variations"),
    "/v1/images/inpainting": ("image", "images_inpainting"),
    "/v1/images/ocr": ("image", "images_ocr"),
    "/v1/images/edits": ("image", "images_edits"),
    "/v1/videos": ("video", "videos"),
