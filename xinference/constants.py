...
XINFERENCE_ENV_DISABLE_QWEN_REACT_RESPONSE_FILTER = (
...
XINFERENCE_DISABLE_QWEN_REACT_RESPONSE_FILTER = bool(
    int(os.environ.get(XINFERENCE_ENV_DISABLE_QWEN_REACT_RESPONSE_FILTER, 0))
)
