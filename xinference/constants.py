...
XINFERENCE_ENV_AUTOSTART_CONFIG = "XINFERENCE_AUTOSTART_CONFIG"
...
XINFERENCE_AUTOSTART_CONFIG_FILE = os.environ.get(
    XINFERENCE_ENV_AUTOSTART_CONFIG,
    os.path.join(XINFERENCE_HOME, "autostart", "models.json"),
)
