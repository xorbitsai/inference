...
XINFERENCE_ENV_DISABLE_CHECK_NODES = "XINFERENCE_DISABLE_CHECK_NODES"
...
XINFERENCE_DISABLE_CHECK_NODES = bool(
    int(os.environ.get(XINFERENCE_ENV_DISABLE_CHECK_NODES, 0))
)
