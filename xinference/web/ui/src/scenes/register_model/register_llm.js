  ...
  return (
    <Box style={{display: 'flex'}}>
      <div className='formBox'>
        {isShow ? <KeyboardDoubleArrowRightIcon className='icon arrow' onClick={() => setIsShow(!isShow)} />
        : <NotesIcon className='icon notes' onClick={() => setIsShow(!isShow)} /> }
      ...
      <div className={!isShow ? 'jsonBox hide' : 'jsonBox'}>
        000000
      </div>
    </Box>
  )
