...
from ...model.image.utils import decode_base64_to_image, encode_pil_to_base64, load_file_from_url
...
def encode_to_base64(image: Image):
...
def encode_np_to_base64(image: Image):
