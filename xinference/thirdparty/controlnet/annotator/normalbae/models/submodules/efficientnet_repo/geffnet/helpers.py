...
def load_pretrained(model, url, filter_fn=None, strict=True):
    ...
    model_dir = os.path.join(os.getenv("XINFERENCE_HOME", Path.home()), ".xinference", "cache",
                             "controlnet", "checkpoints")
    state_dict = load_state_dict_from_url(url, progress=False, map_location="cpu", model_dir=model_dir)
