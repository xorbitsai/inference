...
class GenerateModelHandle(ModelHandle):
    def generate(
        ...
        generate_config: Optional[
            ...
            "LlamaCppGenerateConfig" -> Configuration for LLaMA model.
            "PytorchGenerateConfig" -> Configuration for pytorch model.

        Returns
        -------
        Union["Completion", Iterator["CompletionChunk"]]
            The Completion chunk of the model.
            When stream option is set to True, the response will shows word by word on the screen.
            Otherwise, the response will wait until all words are ready and show the completed response on the screen.
            stream=True -> Iterator["CompletionChunk"]
            stream=False -> "Completion"
...
class ChatModelHandle(GenerateModelHandle):
    def chat(
        ...
        Union["ChatCompletion", Iterator["ChatCompletionChunk"]]
            ...
            When stream option is set to True, the response will shows words by words on the screen.
            Otherwise, the response will wait until all words are ready and show the completed version on the screen.
            stream=True -> Iterator["ChatCompletionChunk"]
...
class ChatglmCppChatModelHandle(ModelHandle):
    def chat(
        ...
        -------
        Union["ChatCompletion", Iterator["ChatCompletionChunk"]]
            The ChatGLM model chat completion chunk generated by the Model.
            When stream option is set to True, the response will shows words by words on the screen.
            Otherwise, the response will wait until all words are ready and show the completed version on the screen.
            stream=True -> Iterator["ChatCompletionChunk"]
            stream=False -> "ChatCompletion"
