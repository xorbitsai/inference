...
chosen quantization method from the options listed above::
   ...
   xinference launch --model-name gorilla-openfunctions-v1 --size-in-billions 7 --model-format pytorch --quantization ${quantization}
...
chosen quantization method from the options listed above::
   ...
   xinference launch --model-name gorilla-openfunctions-v1 --size-in-billions 7 --model-format ggufv2 --quantization ${quantization}
