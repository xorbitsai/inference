...
- **Model Hubs**:  `Hugging Face <https://huggingface.co/Qwen/Qwen3.6-27B>`__, `ModelScope <https://modelscope.cn/models/Qwen/Qwen3.6-27B>`__

Execute the following command to launch the model, remember to replace ``${quantization}`` with your
chosen quantization method from the options listed above::

   xinference launch --model-engine ${engine} --model-name qwen3.6 --size-in-billions 27 --model-format pytorch --quantization ${quantization}
